<div class="col-sm-4">
    <div class="box box-success">
        <div class="box-header with-border text-center">
            <div class="box-title">创建项目</div>
        </div>

        <form role="form" id="create-form" name="create-form" method="POST" action="{{ url('/project') }}" aria-label="创建项目" class="form-horizontal">
            @csrf
            ...
            <div class="box-body">
                ...
                <div class="form-group has-feedback{{ $errors->has('participant') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input id="participant" type="text" class="form-control" name="participant" placeholder="参与人员" value="{{ old('participant') }}">
